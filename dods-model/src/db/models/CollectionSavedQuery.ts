...
export interface SavedQueryOutput extends Required<SavedQueryAttributes> { }

export class CollectionSavedQuery
  ...
  public static associations: {
    collection: Association<CollectionSavedQuery, Collection>;
  };
