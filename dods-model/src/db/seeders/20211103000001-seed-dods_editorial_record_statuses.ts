...
export = {
    up: (queryInterface: QueryInterface) => {
        return queryInterface.bulkInsert('dods_editorial_record_statuses', seedData);
    },
    down: (queryInterface: QueryInterface) => {
        return queryInterface.bulkDelete('dods_editorial_record_statuses', { uuid: { [Op.or]: uuidArray, }, });
    },
};
