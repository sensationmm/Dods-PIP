...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Political Inteligence Platform</title>
