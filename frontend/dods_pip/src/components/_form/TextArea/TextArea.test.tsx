...
describe('InputText', () => {
  it('renders without error', () => {
    const wrapper = shallow(<TextArea label="Example" value={'Example'} onChange={jest.fn} />);
  ...
  it('fires onChange method', () => {
    ...
    const wrapper = shallow(<TextArea label="Example" value={''} onChange={typeWatcher} />);
  ...
  it('should show the current amount of characters next to the total allowed', () => {
    ...
    const wrapper = shallow(
      <TextArea onChange={typeWatcher} value={value} characterLimit={characterLimit} />,
    );
    const component = wrapper.find('[data-test="textarea-label-character-limit"]');
