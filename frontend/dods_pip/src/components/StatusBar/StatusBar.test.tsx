...
import StatusBar, { MainContent, MobileComponent } from '.';
...
describe('Status Bar', () => {
  ...
  describe("When viewport is mobile", () => {
    ...
    it("should render component successfully", () => {
      const wrapper = shallow(<MobileComponent />)
      const component = wrapper.find('[data-test="mobile-component"]')
      expect(component.length).toEqual(1)
    })
  ...
  describe("tagConstructor test", () => {
    it("When de configuration is set to in_progress it should have the pencil icon and the coulor should be color.theme.blueLight", () => {
    ...
    it("When de configuration is set to Scheduled it should have the clock icon and the coulor should be color.accent.green", () => {
    ...
    it("When de configuration is set to published it should have the Tick icon and the coulor should be color.accent.green", () => {
  ...
  it("MainContent reders without issues", () => {
    ...
    const container = wrapper.find('[data-test="statusbar-wraper"]')
