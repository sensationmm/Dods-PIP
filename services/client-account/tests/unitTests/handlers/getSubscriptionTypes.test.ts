import { HttpResponse, HttpStatusCode, createApiGatewayProxyEvent, createContext } from '@dodsgroup/dods-lambda';
...
const SUCCESS_SUBSCRIPTION_TYPE_RESPONSE = [
    {
        uuid: 'ea06b7da-c2ec-47bc-bea5-ec528b1f46a8',
        name: 'Level 1',
        location: 1,
        contentType: 1,
    },
    {
        uuid: 'ea06b7da-c2ec-47bc-bea5-ec528b1f46a9',
        name: 'Level 2',
        location: 2,
        contentType: 2,
    },
    {
        uuid: 'ea06b7da-c2ec-47bc-bea5-ec528b1f46b0',
        name: 'Level 3',
        location: 3,
        contentType: 3,
    },
